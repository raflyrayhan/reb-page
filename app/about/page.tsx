...
function LegalCertifications() {
  ...
  const handlePrev = () => {
    setCurrent((prev) => (prev === 0 ? certifications.length - 1 : prev - 1));
  };

  const handleNext = () => {
    setCurrent((prev) => (prev === certifications.length - 1 ? 0 : prev + 1));
  };
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center justify-between">
          ...
          <div
            ...
            onClick={() => openModal(certifications[current].image)}
          >
            <Image
    ...
    <>
      ...
      <section className="relative h-[100vh] w-full bg-black">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10">
          <h1 className="text-6xl md:text-[4rem] font-bold text-black mb-4">
            About Us
          </h1>
